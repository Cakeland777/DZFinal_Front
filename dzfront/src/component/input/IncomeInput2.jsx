...
const IncomeInput2 = () => {
  ...
  const Tab = [
    ...
    <Calendar payment_ym={format(startDate.current||new Date(),"yyyyMM")}
              worker_id = {"yuchan2"} earner_code={selectedCode.current} 
              workDate ={workDate}  />
      </div>
    }
  ];
  ...
  <button onClick={setDate} style={{marginRight:"2rem"}}> 조회</button>
      ...
      <div id="content">
        ...
        <div style={{float:"left" ,marginLeft:"50px",marginTop:'40px',width:"1500px",height:"1000px"}}>
        {Tab.map((e, index) => (
