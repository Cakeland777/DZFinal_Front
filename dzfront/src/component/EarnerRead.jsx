...
const EarnerRead = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    { field: "artist_type", headerName: "소득구분", resizable: true },
    { field: "artist_ins_red", headerName: "귀속년월", resizable: true },
    { field: "total_payment", headerName: "지급년월일", resizable: true },

    { field: "dif_payment", headerName: "지급액", resizable: true },
    { field: "belonging_ym", headerName: "세율(%)", resizable: true },
    { field: "payment_date", headerName: "학자금상환액", resizable: true },
    ...
    { field: "zonecode", headerName: "차인지급액", resizable: true },
  ]);
