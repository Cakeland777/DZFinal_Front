...
const Registration = (props) => {
    ...
    if (preCode !== props.value && props.value !== "") {
      fetch("http://localhost:8080/regist/get_earner", {
        ...
        .then((data) => {
          ...
          document.querySelector("#deduction_amount").value =
            data.earner_info.deduction_amount || "";
          if (
            data.earner_info.is_artist === "Y" ||
            data.earner_info.div_type === "예술인"
          ) {
            setInputEnabled(true);
            document.querySelector("#artist_type").value =
              data.earner_info.earner_type || "";
          }
          if (
          ...
          if (
            data.earner_info.is_sworker === "Y" ||
            data.earner_info.div_type === "특고인"
          ) {
            setInputEnabledS(true);
            document.querySelector("#sworker_type").value =
              data.earner_info.earner_type || "";
          }
          if (
  ...
  const specialColumn = [
    ...
    {
      headerName: "경비공제율(~22.06)",
      field: "deduction_rate_before_2207",
      width: 120,
    },
    {
      headerName: "경비공제율(~22.07)",
      field: "deduction_rate_after_2207",
      width: 120,
    },
    {
      headerName: "고용정액(~22.06)",
      field: "fixed_amount_before_2207",
      width: 90,
    },
    {
      headerName: "고용정액(~22.07)",
      field: "fixed_amount_after_2207",
      width: 90,
    },
    {
      headerName: "산재보수(~22.06)",
      field: "workinjury_compensation_before_2207",
      width: 90,
    },
    {
      headerName: "산재보수(~22.07)",
      field: "workinjury_compensation_after_2207",
      width: 90,
    },
  ];
  ...
  const handlePostcode = (data) => {
    ...
    document.querySelector(
      "#address"
    ).value = `${data.address} ${data.buildingName}`;
  ...
  const onChange = (e) => {
    ...
    if (name === "is_tuition") {
      ...
      if (value === "N") {
        document.querySelector("#deduction_amount").value = 0;
      }
    }
    ...
    if (name === "is_tuition") {
      ...
      if (value === "N") {
        ...
        fetch("http://localhost:8080/regist/earner_update", {
          ...
          .then((response) => {})
          .then((jsonData) => {
            setEarner({ ...earner, deduction_amount: 0 });
          });
      }
    }
    if (name === "is_artist") {
                ...
                <tr>
                  ...
                  <td style={{ textAlign: "left", width: "75%" }}>
                    <select
                      name="earner_type"
                      id="artist_type"
                      disabled={!inputEnabled || earner.div_type === "특고인"}
                      onBlur={handleBlur}
                      onChange={onChange}
                      value={
                        earner.div_type === "예술인" ? earner.earner_type : ""
                      }
                      defaultValue={""}
                    >
                      <option value=""> </option>
                ...
                <tr>
                  ...
                  <td style={{ textAlign: "left", width: "75%" }}>
                    <select
                      ...
                      id="ins_reduce"
                      value={
                        earner.div_type === "예술인" ? earner.ins_reduce : ""
                      }
                      disabled={!inputEnabled || earner.div_type === "특고"}
                      onBlur={handleBlur}
                      onChange={onChange}
                      defaultValue={""}
                    >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ textAlign: "left", width: "75%" }} colSpan={3}>
                    <select
                      ...
                      id="sworker_type"
                      value={
                        earner.div_type === "특고인" ? earner.earner_type : ""
                      }
                      disabled={!inputEnabledS || earner.div_type === "예술인"}
                      onBlur={handleBlur}
                      onChange={onChange}
                ...
                <tr>
                  ...
                  >
                    ...
                    <input
                      type="text"
                      id="deduction_rate_before_2207"
                      value={
                        earner.occupation_code
                          ? occupation.deduction_rate_before_2207 + "%"
                          : ""
                      }
                      disabled={!inputEnabledS || earner.div_type === "예술인"}
                      style={{ width: "50px" }}
                    ...
                    <input
                      type="text"
                      id="deduction_rate_after_2207"
                      value={
                        earner.occupation_code
                          ? occupation.deduction_rate_after_2207 + "%"
                          : ""
                      }
                      disabled={!inputEnabledS || earner.div_type === "예술인"}
                      style={{ width: "50px" }}
                ...
                <tr>
                  ...
                  <td style={{ textAlign: "left", width: "75%" }}>
                    ...
                    <input
                      type="text"
                      id="workinjury_compensation_before_2207"
                      value={
                        earner.occupation_code
                          ? occupation.workinjury_compensation_before_2207
                          : ""
                      }
                      disabled={!inputEnabledS || earner.div_type === "예술인"}
                      readOnly
                ...
                <tr>
                  <td
                    style={{ textAlign: "right", backgroundColor: "#F7F7F7" }}
                  >
                    {" "}
                  </td>
                  <td style={{ textAlign: "left", width: "75%" }} colSpan={2}>
                    ...
                    <input
                      ...
                      value={
                        earner.occupation_code
                          ? occupation.workinjury_compensation_after_2207
                          : ""
                      }
                      id="workinjury_compensation_after_2207"
                      disabled={!inputEnabledS || earner.div_type === "예술인"}
                      readOnly
                    />
                    요율{" "}
                ...
                <tr>
                  ...
                  <td style={{ textAlign: "left", width: "75%" }} colSpan={2}>
                    <select
                      name="workinjury_reduce"
                      id="workinjury_reduce"
                      value={earner.workinjury_reduce || ""}
                      disabled={!inputEnabledS || earner.div_type === "예술인"}
                      onBlur={handleBlur}
                      onChange={onChange}
                      defaultValue={""}
  ...
  const onSpecialClicked = () => {
    ...
    document.querySelector("#sworker_type").value =
      specialValue.occupation_type;
    document.querySelector("#occupation_code").value =
      specialValue.occupation_code;
    document.querySelector("#occupation_info").value =
      "[" + specialValue.occupation_code + "]" + specialValue.occupation_name;
    document.querySelector("#deduction_rate_after_2207").value =
      specialValue.deduction_rate_after_2207;
    document.querySelector("#deduction_rate_before_2207").value =
      specialValue.deduction_rate_before_2207;
    document.querySelector("#workinjury_compensation_after_2207").value =
      specialValue.workinjury_compensation_after_2207;
    document.querySelector("#workinjury_compensation_before_2207").value =
      specialValue.workinjury_compensation_before_2207;
  };
  ...
  return (
    <div>
      ...
      >
        ...
        {currentItem.content}
        {currentItem === Tab[1] &&
          earner.earner_code !== preCode &&
          changeItem(0)}
      </div>
      <ReactModal
        style={specialStyles}
        isOpen={specialModalOpen}
        onRequestClose={() => setSpecialModalOpen(false)}
      >
        {
          <>
            <h4>특고 직종코드 코드도움</h4>
            ...
            <>
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <button onClick={{ onSpecialClicked }}>확인</button>
              </div>
            </>
          </>
        }
